...
exports.transformPackage = void 0;
...
function transformPackage(content, basePath) {
    return __awaiter(this, void 0, void 0, function* () {
        const contentXml = (yield parseStringAsync(content));
        if (!contentXml) {
            throw new Error("Empty XML, please check your src folder for file package.xml");
        }
        const resultBasePath = path_1.join(basePath, "../typings/");
        try {
        ...
        for (const widgetFileXml of widgetFileXmls) {
            ...
            const source = yield readFile(path_1.join(basePath, sourcePath), "utf-8");
            let generatedContent;
            try {
                const sourceXml = (yield parseStringAsync(source));
                generatedContent = generate_1.generateForWidget(sourceXml, toWidgetName(sourcePath));
            }
            catch (err) {
            ...
            yield writeFile(path_1.join(resultBasePath, resultPath), generatedContent);
        }
    });
}
